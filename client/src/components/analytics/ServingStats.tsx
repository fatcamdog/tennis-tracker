        ...
        <div>
            <div>
                ...
                <div>
                    ...
                    <p>
                        ...
                        {firstServeWinPercentage(true)}
                    </p>
                    <p>
                        Second serve percentage: {secondServePercentage(true)}
                    </p>
                    <p>
                        Second serve win percentage:{' '}
                        {secondServeWinPercentage(true)}
                    </p>
                    ...
                    <p>
                        ...
                        {percentageForehandAndBackhandReturnsWon(
                            true,
                            'forehand'
                        )}
                    </p>
            ...
            <div>
                ...
                <div>
                    ...
                    <p>
                        First serve win percentage:{' '}
                        {firstServeWinPercentage(false)}
                    </p>
                    <p>
                        Second serve percentage: {secondServePercentage(false)}
                    </p>
                    <p>
                        Second serve win percentage:{' '}
                        {secondServeWinPercentage(false)}
                    </p>
                    ...
                    <p>
                        Percentage serves to forehand:{' '}
                        {percentageForehandAndBackhandReturns(
                            false,
                            'forehand'
                        )}
                    </p>
